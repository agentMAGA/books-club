      ...
      <main>
        ...
        <section className={styles.innerSpacing}>
          ...
          <p className={styles.textRegulirovca}>
            Arête — это постоянное стремление к совершенству и полной реализации
            своего потенциала. Мы начали с книг, ведь именно они зажигают в нас
            первые звезды любознательности. Но наш путь не заканчивается на этом
            — он только начинается.
          </p>
          <p className={styles.textRegulirovca}>
            Наш клуб — это созвездие искателей.{" "}
          </p>
          <p className={styles.textRegulirovca}>
            Мы — навигаторы в безграничном космосе искусства, дизайна, кино,
            литературы и многого другого.
          </p>
          <p className={styles.textRegulirovca}>
