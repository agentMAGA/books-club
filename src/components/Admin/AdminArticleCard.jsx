...
const AdminArticleCard = ({
  ...
  return (
    <article className={styles.card}>
      {/* ВЕРХНЯЯ СТРОКА: тип, автор, статус */}
      ...
      {/* КОНТЕНТ: клик по карточке = открыть */}
      ...
      {/* НИЖНЯЯ СТРОКА: дата + крупные иконки + модерация */}
